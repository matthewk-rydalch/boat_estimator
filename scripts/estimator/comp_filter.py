...
def run(belief,ut,dt,kp,ki,gravity):
     ...
     # qAccel[1] = np.arcsin(aBody.item(0)/-gravity.item(2)) #TODO should this be arctan?  Then it wouldn't break due to domain.
     qAccel[1] = np.arctan2(aBody.item(0),aBody.item(2))
