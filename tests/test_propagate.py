...
class TestPropagation(unittest.TestCase):
    def test_zeros(self):
        ...
        beliefExpected = StatesCovariance(pExpected, qExpected, vExpected, baExpected, bgExpected, cov0)
    ...
    #     belief.P = P
    #     ft = DynamicModel()
    #     ekf.propagate(belief,Rt,ft,At,dt)
    ...
    def assert_states_equal(self,belief,beliefExpected):
        for i in range(3):
            self.assertAlmostEqual(belief.p.item(i),beliefExpected.p.item(i))
            self.assertAlmostEqual(belief.q.item(i),beliefExpected.q.item(i))
            self.assertAlmostEqual(belief.v.item(i),beliefExpected.v.item(i))
            self.assertAlmostEqual(belief.ba.item(i),beliefExpected.ba.item(i))
            self.assertAlmostEqual(belief.bg.item(i),beliefExpected.bg.item(i))
